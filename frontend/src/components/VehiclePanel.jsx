...
const VehiclePanel = ({ setConfirmRidePanel, setVehiclePanel, fareDetails, distanceTime }) => {
  return (
    <div>
      <h5 onClick={() => {
      ...
      {fareDetails && (
        <>
          <div onClick={() => {
            ...
            <h2 className='text-2xl font-semibold'>₹{fareDetails.car}</h2>
          </div>
          <div onClick={() => {
            setConfirmRidePanel(true)
          }} className='flex border-2 bg-white active:border-yellow-700 mb-2 rounded-xl p-3 w-full items-center justify-between'>
            ...
            <h2 className='text-2xl font-semibold'>₹{fareDetails.auto}</h2>
          </div>
          <div onClick={() => {
            setConfirmRidePanel(true)
          }} className='flex border-2 bg-white active:border-yellow-700 mb-2 rounded-xl p-3 w-full items-center justify-between'>
            ...
            <h2 className='text-2xl font-semibold'>₹{fareDetails.moto}</h2>
          </div>
        </>
      )}
    </div>
